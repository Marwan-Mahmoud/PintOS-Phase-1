...
struct thread
  {
    ...
    int priority;
    int org_priority;                   /* Holds original priority when donation happens */
    ...
    struct list locks_aquired;          /* List of locks that the thread is holding now. */
...
void update_recent_cpu_each(void);
